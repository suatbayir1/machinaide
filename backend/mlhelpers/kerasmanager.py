...
from mlhelpers.mlauto import RULReportIntermediates, RULRandomSearch, RULModelBuilder, RULHyperband, RULBayesianOptimization, AUTOML_OPTIMIZERS
from config import RUL_SEQUENCE_LENGTH
...
class KerasModelBuilder:
    ...
    def initialize(self, X_train, y_train, tuner_type, experiment_name):
        ...
        model_builder = RULModelBuilder(RUL_SEQUENCE_LENGTH, X_train, y_train, optimizer["compile"])
        self.X_train = X_train
        self.y_train = y_train
        if tuner_type == "hyperband":
            self.tuner = RULHyperband(model_builder,
            ...
            self.tuner = RULRandomSearch(model_builder,
            ...
            self.tuner = RULBayesianOptimization(model_builder,
                            objective=optimizer["objective"],
                            max_trials=10,
