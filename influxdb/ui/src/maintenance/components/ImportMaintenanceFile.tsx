...
class ImportMaintenanceFile extends PureComponent<Props, State> {
                ...
                if (row["asset"] !== "" && row["sid"] !== "" && row["date"] !== "" && row["faultType"] !== "" && row["maintenanceType"] !== "") {
                    ...
                    if (response.data.summary.code === 409) {
                        let error = {
                            "type": "DUPLICATED",
                            "color": "green",
                            "text": `In line: ${index + 1} DUPLICATED: This maintenance record already exists.`
                        }
                        this.setState({
...
export default ImportMaintenanceFile;