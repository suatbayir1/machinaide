...
class AutoML extends PureComponent<Props, State> {
    constructor(props) {
        super(props)
    ...
    getExperimentData = () => {
        ...
        AutoMLService.getTrialDetails(experimentName).then(res => {
            let allHypers = []
            let allTrials = []
            ...
            this.setState({ trials: JSON.parse(res["trials"]), hyperData: allHypers, trialsList: allTrials, bestMetric: bestMetric }, () => {
                AutoMLService.getTrialIntermediates(experimentName).then(res => {
                    let ints = []
