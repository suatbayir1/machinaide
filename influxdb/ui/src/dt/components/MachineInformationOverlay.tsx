...
import {
    ...
    MultiSelectDropdown, Input, TextArea, Overlay
...
type Props = {
    ...
    clickBrands: () => void
    orgID: string
    isMachineInformationOverlayVisible: boolean
    handleDismissMachineInformationOverlay: () => void
}
...
class MachineInformationOverlay extends PureComponent<Props, State> {
    constructor(props) {
        super(props);
    ...
    private updateMachineConfirmed = async (): Promise<void> => {
        ...
        if (updatedResult.summary.code === 200) {
            this.props.handleDismissMachineInformationOverlay()
    ...
    public render() {
        const { selectedGraphNode, clickPartDetail, clickBrands, isMachineInformationOverlayVisible, handleDismissMachineInformationOverlay } = this.props;
        const {
        ...
        return (
            <>
                <Overlay visible={isMachineInformationOverlayVisible}>
...
export default MachineInformationOverlay;