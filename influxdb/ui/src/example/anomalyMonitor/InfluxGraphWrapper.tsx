...
import {
  Grid, Columns, MultiSelectDropdown, SlideToggle, ButtonType, ComponentColor,
  Input, InputType, SelectDropdown, Button
...
export const InfluxChart = ({ orgID, query, onClick, selectedSensors, setSelectedInParent, anomalies }) => {
      ...
      <Grid.Row>
        ...
        {/* <Grid.Column widthXS={Columns.Two}>
          <input
              type='date'
              value={time}
              onChange={(e) => { setTime(e.target.value); console.log(e.target.value) }}
        ...
        {/* <Grid.Column widthXS={Columns.One}>
          <Input
            onChange={(e) => {setBucketNo(e.target.value); console.log(e.target.value)}}
            name=""
            testID="input-field"
      ...
      <Grid.Row>
        <Grid.Column widthXS={Columns.Twelve}>
          <div style={{ height: '475px', background: "white", color: "black" }}>
            <InfluxGraph data={shownData} onClick={onClick} anomalies={anomalies} />
          </div>
        </Grid.Column>
      </Grid.Row>
    </>
