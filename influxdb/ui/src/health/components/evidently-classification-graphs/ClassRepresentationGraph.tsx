    ...
    componentDidMount(): void {
      if(this.props.report){
        ...
        if(confusionMatrix.length === 2){
          class0 = confusionMatrix[0][0] + confusionMatrix[0][1]
          class1 = confusionMatrix[1][0] + confusionMatrix[1][1]
        }
        else{
          let label = report["classification_performance"]["data"]["metrics"]["reference"]["confusion_matrix"]["labels"][0]
          if(label){
            class0 = 0
            class1 = confusionMatrix[0][0]
          }
          else{
            class0 = confusionMatrix[0][0]
            class1 = 0
          }
        }
