...
import POFFeedbackBrushGraph from 'src/health/components/feedback-pages/POFFeedbackBrushGraph'
...
class POFFeedbackPage extends PureComponent<Props, State>{
    state = {
        timeRange: {
            seconds: 3600,
            lower: "now() - 1h",
    ...
    */
    ...
    render(): React.ReactNode {
        return(
            <Page
                titleTag="Probaility of Failure Model Feedback"
                className="alert-history-page"
            >
                <Page.Header fullWidth={true}>
                    <Page.Title
                        title="Probability of Failure Model Feedback"
                    />
                </Page.Header>
                            ...
                            <Grid.Column widthXS={Columns.Twelve} style={{height: "700px"}}>
                                <Panel style={{border: 'solid 2px #999dab', borderRadius: '4px', height: "inherit"}}>
                                    ...
                                    <Panel.Body size={ComponentSize.Small}>
                                        <div>
                                            {this.state.isDataLoaded ? <POFFeedbackBrushGraph  /* this.state.machineSensorData.length */
...
export default POFFeedbackPage