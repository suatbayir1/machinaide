...
import {
  ...
  MODEL_LOG_GRAPH_SELECTABLE_TIME_RANGES,
...
class ModelLogGraphTimeRangeDropdown extends PureComponent<Props, State> {
          ...
          <Dropdown
            ...
            menu={onCollapse => (
              ...
              >
                ...
                {MODEL_LOG_GRAPH_SELECTABLE_TIME_RANGES.map(({label}) => {
  ...
  private handleClickDropdownItem = (label: string): void => {
    ...
    const timeRange = MODEL_LOG_GRAPH_SELECTABLE_TIME_RANGES.find(t => t.label === label)

    onSetTimeRange(timeRange)
  }
}

export default ModelLogGraphTimeRangeDropdown
