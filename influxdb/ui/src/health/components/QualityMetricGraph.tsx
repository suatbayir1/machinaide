...
class QualityMetricGraph extends PureComponent<Props>{
    ...
    componentDidMount(){
        ...
        let precision0 = classValues["0"]["precision"]
        let precision1 = classValues["1"]["precision"]
        let recall0 = classValues["0"]["recall"]
        let recall1 = classValues["1"]["recall"]
        let f1Score0 = classValues["0"]["f1-score"]
        let f1Score1 = classValues["1"]["f1-score"]
