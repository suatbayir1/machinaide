...
class RULModelLogGraph extends PureComponent<Props, State>{
    ...
    render(): React.ReactNode {
        return(
            <div style={{height: "inherit", color: "black"}}>
                {this.state.modelLogDataPoints.length && <ResponsiveLine 
                    data={[{"id": "logs", "data": this.state.modelLogDataPoints}]}
