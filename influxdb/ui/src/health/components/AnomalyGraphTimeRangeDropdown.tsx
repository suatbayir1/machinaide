...
import {
  ...
  ANOMALY_GRAPH_SELECTABLE_TIME_RANGES,
...
class AnomalyGraphTimeRangeDropdown extends PureComponent<Props, State> {
          ...
          <Dropdown
            ...
            menu={onCollapse => (
              ...
              >
                ...
                {ANOMALY_GRAPH_SELECTABLE_TIME_RANGES.map(({label}) => {
  ...
  private handleClickDropdownItem = (label: string): void => {
    ...
    const timeRange = ANOMALY_GRAPH_SELECTABLE_TIME_RANGES.find(t => t.label === label)

    onSetTimeRange(timeRange)
  }
}

export default AnomalyGraphTimeRangeDropdown
