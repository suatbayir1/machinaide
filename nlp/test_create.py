...
def create_ner_train_data():
    ...
    with open('/home/machinaide/nlp/assets/train_data_merge.json', 'w') as outfile:
        outfile.write(
            '[\n\t')
...
def create_texcat_train_data():
    ...
    with open('/home/machinaide/nlp/assets/train_textcat.jsonl', 'w') as outfile:
...
def create_mongo_texcat_train_data():
    ...
    with open('/home/machinaide/nlp/assets/train_mongo_textcat.jsonl', 'w') as outfile:
        for line in srsly.read_jsonl('/home/machinaide/nlp/mongo-textcat/assets/train_data.jsonl'):
            outfile.write(json.dumps(line))
            outfile.write('\n')
        outfile.write('\n'.join(json.dumps(data) for data in train_data))
